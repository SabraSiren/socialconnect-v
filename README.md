...
- `PATCH /auth/me/avatar` — смена аватара (тело: `{ "avatar_id": "<file_id>" | null }`)
...
- Установка/смены (по клику на аватар) и удаления (в меню OptionMenu) аватара, добавления картинки в пост, удаление из превью постформы.
